...
type MobileProjectTableOfContentsProps = {
  toc: TOC[]
}

function MobileProjectTableOfContents(props: MobileProjectTableOfContentsProps) {
  const { toc } = props
      ...
      <PopoverTrigger
        ...
        render={
          <Button variant='secondary' className='fixed right-2 bottom-2 z-50 lg:hidden'>
            <AlignLeftIcon data-icon='inline-start' /> {t('projects.on-this-page')}
          </Button>
        }
      />
...
export default MobileProjectTableOfContents
