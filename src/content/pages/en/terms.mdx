...
- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Issam Seghir.
...
- **Website** refers to Issam Seghir's portfolio, accessible from the site URL
...
- By email: issamusma@hotmail.com
