...
**Captions | Your AI-powered creative studio** is a **recreation of the [Captions.ai](https://web.archive.org/web/20240309164043/https://www.captions.ai/) marketing landing page**. The focus is on **motion design** (GSAP, Lottie), **smooth scrolling**, and a **more performant, accessible** implementation than the reference site.
...
This build targets **stronger performance and accessibility than the official [Captions.ai](https://web.archive.org/web/20240309164043/https://www.captions.ai/) marketing site**, with a **Lighthouse capture of the original** for context ([screenshot on Imgur](https://i.imgur.com/fCqSHnk.png)).
