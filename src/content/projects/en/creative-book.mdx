---
name: Creative Book
description: Creative Book — book store landing with Next.js, Framer Motion, bento layout, and EN/AR i18n
...
**Creative Book** is a **book store landing page** powered by **Next.js** and **Framer Motion**, focused on smooth motion, a **bento grid** layout, and a bilingual experience.
